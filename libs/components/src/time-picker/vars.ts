export const CLASSES = {
  ...
  'time-picker-popup--top': '^time-picker-popup--top',
  'time-picker-popup--top-left': '^time-picker-popup--top-left',
  'time-picker-popup--top-right': '^time-picker-popup--top-right',
  'time-picker-popup--bottom': '^time-picker-popup--bottom',
  'time-picker-popup--bottom-left': '^time-picker-popup--bottom-left',
  'time-picker-popup--bottom-right': '^time-picker-popup--bottom-right',
