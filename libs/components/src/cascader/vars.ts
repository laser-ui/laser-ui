export const CLASSES = {
  ...
  'cascader-popup--top': '^cascader-popup--top',
  'cascader-popup--top-left': '^cascader-popup--top-left',
  'cascader-popup--top-right': '^cascader-popup--top-right',
  'cascader-popup--bottom': '^cascader-popup--bottom',
  'cascader-popup--bottom-left': '^cascader-popup--bottom-left',
  'cascader-popup--bottom-right': '^cascader-popup--bottom-right',
