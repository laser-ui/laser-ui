export const CLASSES = {
  ...
  'select-popup--top': '^select-popup--top',
  'select-popup--top-left': '^select-popup--top-left',
  'select-popup--top-right': '^select-popup--top-right',
  'select-popup--bottom': '^select-popup--bottom',
  'select-popup--bottom-left': '^select-popup--bottom-left',
  'select-popup--bottom-right': '^select-popup--bottom-right',
