...
How to use [Virtual Scroll](/components/VirtualScroll) to handle large data.

# zh-CN

如何使用 [虚拟滚动](/components/VirtualScroll) 处理大数据。

```tsx
import { Button, Separator, Table, VirtualScroll } from '@laser-ui/components';
