          ...
          <tr>
            <Table.Th
              ...
              action={
                ...
                >
                  {(filterProps) => (
                    <Table.ThAction {...filterProps} active={!!filter.name}>
                      <Icon>
                        <FilterAltFilled />
                      </Icon>
                    </Table.ThAction>
            ...
            <Table.Th
              ...
              action={
                  ...
                  content={
                    ...
                    >
                      {(groupProps, optionProps, options) => (
                        ...
                        >
                          {options.map((opt) => (
                            <div key={opt.value} className="d-flex align-items-center" style={{ minHeight: 28 }}>
                ...
                >
                  {(filterProps) => (
                    <Table.ThAction {...filterProps} active={filter.age.length > 0}>
                      <Icon>
                        <FilterAltFilled />
                      </Icon>
                    </Table.ThAction>
            ...
            <Table.Th
              action={
                ...
                >
                  {(filterProps) => (
                    <Table.ThAction {...filterProps} active={filter.address.length > 0}>
                      <Icon>
                        <SearchOutlined />
                      </Icon>
                    </Table.ThAction>
