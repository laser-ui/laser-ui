...
If the `ellipsis` prop is `true`, the content is automatically omitted. Global configuration is supported.
...
```tsx
import { Button, Separator, Table } from '@laser-ui/components';
