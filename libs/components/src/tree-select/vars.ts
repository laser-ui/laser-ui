export const CLASSES = {
  ...
  'tree-select-popup--top': '^tree-select-popup--top',
  'tree-select-popup--top-left': '^tree-select-popup--top-left',
  'tree-select-popup--top-right': '^tree-select-popup--top-right',
  'tree-select-popup--bottom': '^tree-select-popup--bottom',
  'tree-select-popup--bottom-left': '^tree-select-popup--bottom-left',
  'tree-select-popup--bottom-right': '^tree-select-popup--bottom-right',
