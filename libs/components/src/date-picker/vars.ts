export const CLASSES = {
  ...
  'date-picker-popup--top': '^date-picker-popup--top',
  'date-picker-popup--top-left': '^date-picker-popup--top-left',
  'date-picker-popup--top-right': '^date-picker-popup--top-right',
  'date-picker-popup--bottom': '^date-picker-popup--bottom',
  'date-picker-popup--bottom-left': '^date-picker-popup--bottom-left',
  'date-picker-popup--bottom-right': '^date-picker-popup--bottom-right',
